<div class="registration-container">
  <div
    ...
    <form action="index.php?class=login&act=handleRegister" method="POST">
      <?php
      ...
      <div class="mb-1">
        <label for="email_reg" class="form-label fw-medium text-dark small">Địa chỉ Email</label>
        <input
          type="email"
          id="email_reg"
          name="email"
      ...
      <div class="mb-1">
        <label
          for="password_reg"
          class="form-label fw-medium text-dark small">Mật khẩu</label>
        <input
          type="password"
          id="password_reg"
          name="password"
      ...
      <div class="mb-1">
        <label
          ...
          class="form-label fw-medium text-dark small">Xác nhận Mật khẩu</label>
        <input
          type="password"
          id="confirm_password"
